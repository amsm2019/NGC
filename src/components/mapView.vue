...
/**
 * 按需引入Openlayers地图框架组件
 * ref: https://openlayers.org/en/latest/doc/tutorials/bundle.html
 */
import 'ol/ol.css';
...
const constructSource = () => {
  ...
  let basemap_link = 'http://112.125.26.159:8080';
  let baseUrl = basemap_link + '/geoserver/gwc/service/wmts';
  let style = '';
  let format = 'image/png';
  let layerName = 'China:world-dark';
  let projection = new proj_Projection({
      code: 'EPSG:900913',
      units: 'm',
      axisOrientation: 'neu'
  });
